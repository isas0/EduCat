...
<body>
	...
	<div class="form-page-container">
		<div class="form-box" style="max-width: 450px;">
			...
			%>
			<div
				style="background-color: #ffebee; color: #c62828; padding: 10px; border-radius: 8px; margin-bottom: 20px; text-align: center; border: 1px solid #ef9a9a;">
				<%= error %>
			</div>
			<% } %>
			...
			<form action="<%= request.getContextPath() %>/login" method="POST">
				...
				<div class="form-group">
					<label class="form-label">Password</label> <input type="password"
						name="password" class="form-input" required placeholder="********">
				</div>

				<button type="submit" class="submit-btn"
					style="background-color: #1A5C61;">Accedi</button>
			</form>
